...
DBAL umožňuje pokládat dotazy i za pomocí vlastně vytvořeného SQL. Příklad lze vidět ve výpisu \ref{src:w2p-query} na řádku 20. Tento dotaz však nevrací data ve formě instancí třídy \lstinline[style=custompython]|web2py.gluon.dal.Row|, ale v nejzákladnější formě jakou vrací konkrétní databázový ovladač. \\
